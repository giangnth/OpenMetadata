...
The Delta Lake connector internally spins up a Spark Application (`pyspark` 3.X) to connect to your Hive Metastore and extract metadata from there.
...
You can find further information on the Delta Lake connector in the [docs](https://docs.open-metadata.org/connectors/database/Hudi).
