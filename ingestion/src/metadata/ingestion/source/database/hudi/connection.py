...
from metadata.ingestion.source.database.hudi import configure_spark_with_hudi_pip


def get_connection(connection: HudiConnection) -> SparkSession:
    """
    Create connection
    """
    ...
    return configure_spark_with_hudi_pip(builder).getOrCreate()


def test_connection(
    metadata: OpenMetadata,
    spark: SparkSession,
    service_connection: HudiConnection,
